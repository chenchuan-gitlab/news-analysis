    ...
    function showData(object) {
        ...
        for (var i = 0; i < object.rows.length; i++) {
            ...
            html += "<td class='td-manage'>" +
                "<a title='查看' onclick=xadmin.open('查看','./newsInfo-view.jsp?id=" + object.rows[i].id + "',600,400) href='javascript:;'><i class='layui-icon' style='font-size: 23px'>&#xe633;</i></a></td></tr>";
        }
        if (html.length == 0) {
